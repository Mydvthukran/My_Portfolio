...
const Contact = () => {
  ...
  const socials = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/manish-yadav-483613323/',
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/Mydvthukran',
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/manishyadavthukran/',
          ...
          >
            ...
            <div className="contact-social-links">
              {socials.map((social, i) => (
                <a key={i} href={social.url} target="_blank" rel="noopener noreferrer" className="contact-social-link">
                  {social.icon}
